...
/*   Updated: 2019/10/18 12:00:53 by qperrot-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		**ft_put_char(char **str, char const *s, char c, int words)
{
	int		i;
	int		j;
	int		k;
...
static int		ft_len_words(char const *s, int *ptr, char c)
{
	int		len;
